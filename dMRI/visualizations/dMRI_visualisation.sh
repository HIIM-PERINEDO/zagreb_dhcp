...
case $processing_step in
    ...
    "PREPROCESS")
        ...
        #mrview $preprocdir/meanb1000.mif.gz -mode 2 -roi.load $preprocdir/mask.mif.gz 
    ;;
    "RESPONSE")
        ...
        #mrview  $preprocdir/meanb0_brain.mif.gz -overlay.load $responsedir/${response}_sf.mif.gz -overlay.opacity 0.5 -mode 2
    ...
    "CSD")
        ...
        response=dhollander
        mrview -load $csddir/dwi_preproc_inorm.mif.gz -odf.load_sh $csddir/$response/csd_${response}_wm_2tt.mif.gz -mode 2
    ;;
    "5TT")
        echo "Processing 5TT"
        # Add your command here
