...
do
    ...
    outputFolder=$studyFolder/derivatives/dhcp_structural_pipeline_segm-add_M-CRIB-raw/$subjectID
    ...
    T2=$studyFolder/M-CRIB_T2-weighted_images/M-CRIB_raw_T2/M-CRIB_${subjectID}_T2_raw
    T1=$studyFolder/M-CRIB_T1-weighted_images/M-CRIB_raw_T1/M-CRIB_${subjectID}_T1_raw
