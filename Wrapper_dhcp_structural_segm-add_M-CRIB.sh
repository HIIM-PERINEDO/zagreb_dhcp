...
do
    ...
    T2=$studyFolder/M-CRIB_T2-weighted_images/M-CRIB_preprocessed_T2/M-CRIB_${subjectID}_T2.nii.gz 
    T1=$studyFolder/M-CRIB_T1-weighted_images/M-CRIB_preprocessed_T1/M-CRIB_${subjectID}_T1.nii.gz 
